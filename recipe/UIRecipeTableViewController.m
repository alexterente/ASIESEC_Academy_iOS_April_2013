...
- (NSArray *)recipeFromArry:(NSArray *)jsonArray{
    ...
    for (NSDictionary *currentDictionary in jsonArray) {
        Recipe *newRecipe = [[Recipe alloc] initWithName:currentDictionary[@"Name"]
...
- (void)viewDidLoad
{
    ...
    Recipe *newRecipe = [[Recipe alloc] initWithName:@"Lasania" andDescription:@"Description"];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    // Configure the cell...
    Recipe *currentRecipe = [dataSourceArray objectAtIndex:indexPath.row];
